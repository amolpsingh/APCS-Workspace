...
public class MyTreeSet<E>
{
    ...
    private int countNodesHelper( TreeNode<E> root )
    {
        ...
        int counter1 = countNodesHelper( root.getLeft() );
        int counter2 = countNodesHelper( root.getRight() );
        return 1 + counter1 + counter2;
    }
    ...
    private int[] nodeCounts( TreeNode<E> root )
    {
        ...
        answers[0] = countNodesHelper( root );

        answers[1] = Math.abs( countNodesHelper( root.getRight() ) 
